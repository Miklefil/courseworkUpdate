...
INSTALLED_APPS = [
    ...
    "users",
    "mailings",  # добавлено приложени
    "mailings.templatetags",  # добавлена папка медиа
...
if CACHE_ENABLED:
    CACHES = {
        "default": {
            ...
            "LOCATION": os.getenv("CACHE_LOCATION"),  # для сервера redis-server.exe
        }
    }
